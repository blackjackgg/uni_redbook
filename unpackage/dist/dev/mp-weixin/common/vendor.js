...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"redbook2","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 201:
/*!********************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/uni_redbook/components/j-comment/emo.json ***!
  \********************************************************************************/
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    set_test: function set_test(state, payload) {
      state.fuck = payload;
    },
    //设置token
